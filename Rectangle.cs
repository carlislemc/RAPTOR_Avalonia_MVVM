...
namespace raptor
{
    ...
    public class Rectangle : Component
    {
        ...
        // Add a reusable FontFallbackText instance for measurement/drawing
        private FontFallbackText GetFontFallbackText(double widthConstraint, double fontSize = 12)
        {
    ...
    //            }
        ...
        public override void draw(Avalonia.Media.DrawingContext gr, int x, int y)
        {
            ...
            var fallbackTextX = GetFontFallbackText(double.PositiveInfinity, 12);
            ...
            if ((draw_text) && (this.Text.Length > 0))
            {
                ...
                if (this.Text == "Error")
                {
                    // Use fallback for error text as well
