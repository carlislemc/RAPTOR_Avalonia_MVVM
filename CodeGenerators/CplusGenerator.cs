...
{
    class CplusGenerator : raptor.Generate_Interface, CodeGenerators.Imperative_Interface
    {
        ...
        #region Generate_Interface Members
        ...
        {
            stream.Write("Is_String(" + name.ToLower() + ")");
        }

        public void Emit_Is_Number(string name)
        {
            stream.Write("Is_Number(" + name.ToLower() + ")");
        }

        public void Emit_Is_Character(string name)
        {
            stream.Write("Is_Character(" + name.ToLower() + ")");
        }
        ...
        {
            stream.Write(name.ToLower() + "'Length");
        }
        ...
        public void Input_Past_Prompt()
        {
            ...
            switch (kind_of_input)
            {
                case input_kind.array:
                    stream.Write(input_name.ToLower() + "(");
